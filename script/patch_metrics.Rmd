...
patch_plot <- function(y_var, ylab){
  allpatch.ws %>% 
  ggplot() +
    aes(x = months, y = y_var, color = category, linetype = category) +
  geom_line(size = 3) +
    ...
    labs(x = "Months since restoration", y = ylab, color = "", linetype = "") +
  theme_classic() +
...
land_plot <- function(y_var, ylab){
  allpatchl.w %>% 
  ggplot() +
    aes(x = months, y = y_var) +
  geom_line(size = 3) +
    labs(x = "Months since restoration", y = ylab) +
  theme_classic() +
